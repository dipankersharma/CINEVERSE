...
const Header = ({ value }) => {
  ...
  return (
    ...
    >
      ...
      <p className=" w-[70%] text-s text-white mb-3">
      ...
      <p className="text-white mb-2">
        ...
        {value.release_date || "No information"}
        <i className="ri-album-fill text-yellow-500 ml-2"></i>{" "}
        {value.media_type.toUpperCase()}
      </p>
      <Link
        to={`/${value.media_type}/details/${value.id}/trailer`}
        className="p-3 bg-[#6556CD] rounded-lg text-white font-semibold"
      >
        Watch Trailer
      </Link>
    </div>
